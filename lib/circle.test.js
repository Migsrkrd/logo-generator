...
describe("generateCircleLogo", () => {
    it("should take in three elements and input them into a template literal", () => {
        ...
        <g>
          ...
          <text dominant-baseline="middle" text-anchor="middle" x="100" y="100" font-family="Verdana" font-size="100" fill="red">SVG</text>
        </g>
      </svg>`;
        const circle = new Circle("SVG", "red", "circle", "grey").generateCircleLogo();
